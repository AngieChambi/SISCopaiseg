...
from backengo.utils.security import SecurityKey, log_params, UserToken
from backengo.utils.decorators import permission_resource_required

# models
from backengo.sad.models import User, Module, UserAssociation, UserEnterprise, \
    UserHeadquar, BACKEND, VENTAS, CLINICA
from apps.params.models import Person, NID, IDENTITY_TYPE_CHOICES
from backengo.space.models import Association, Enterprise, Headquar, Solution
...
class LogOutView(generic.RedirectView):
    ...
    def get(self, request, *args, **kwargs):
        messages.info(self.request, "Sesión terminada")
        logout(request)
